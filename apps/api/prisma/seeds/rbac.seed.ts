...
export const SYSTEM_FEATURES = [
  ...
  { key: 'crm.proposals', name: 'Proposals', module: 'crm', description: 'Proposal and contract generation' },
  { key: 'crm.reports', name: 'CRM Reports', module: 'crm', description: 'Sales performance reports' },
