...
export class InvoicePdfService implements OnModuleDestroy {
  ...
  // TODO: use puppeteer-cluster or cache browser instance in production for better performance
...
<body>
  <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;">
    ...
    <div style="text-align:right;font-size:12px;color:#475569;line-height:1.6;">
      CDY Agency<br/>Nairobi, Kenya<br/>finance@cdy.com
    </div>
  </div>
  ...
  <div style="margin-top:48px;padding-top:16px;border-top:1px solid #e2e8f0;text-align:center;font-size:11px;color:#94A3B8;">
